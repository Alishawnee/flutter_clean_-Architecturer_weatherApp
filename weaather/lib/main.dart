...
import 'package:weaather/data/repository/weather_repository.dart';
import 'package:weaather/domain/repository/base_weather_repository.dart';
import 'package:weaather/domain/usecase/get_weather_by_country.dart';
...
Future<void> main() async {
  ...
  Weather weather =
      await GetWeatherByCountryName(baseWeatherRepository).execute("Baghdad");
  runApp(const MyApp());
}
